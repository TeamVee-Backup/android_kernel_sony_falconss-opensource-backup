...
#include <mach/msm_smem.h>  //tracy add for power off charge white screen
...
static int LCD_init=0;  // 20131125 tracy add for white screen after "rebot screen"
			     ...
			     int op_enable)
{
	...
	int ret = 0;
//tracy add for power off charge white screen++
...
//tracy ad for power off charge white screen --
			if (ret == 0) {
