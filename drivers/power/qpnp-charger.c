...
static int temperature_detect_flag;         //Abner 20140225
//[Arima Patch] 20131021 Maintenance charging by Abner	
...
//[Arima Patch] 20131008 Temperature detect for charging by Abner
  ...
  temperature_detect_flag = 0;							//Abner 20140225
...
{
	struct qpnp_chg_chip *chip = _chip;
/* [Arima JimCheng 20140625] solve for USB disconnect issue ++ */
	int rc=0;
...
qpnp_batt_external_power_changed(struct power_supply *psy)
{
	...
	if (qpnp_chg_is_usb_chg_plugged_in(chip)) {
		chip->usb_psy->get_property(chip->usb_psy,
			  POWER_SUPPLY_PROP_CURRENT_MAX, &ret);
	//20140704 set talk mode current after call off		  
	...
	//20140704 set talk mode current after call off
      ...
      //[Arima Patch] 2013225 Temperature detect for charging by Abner 		
          if(temperature_detect_flag == 1){	
      		  qpnp_chg_batt_temp_warning(chip);
      	  }
      //[Arima Patch] 20130225 Temperature detect for charging by Abner 	  
	...
	{
	    temperature_detect_flag = 1;	//[Arima Patch] 20130225 Temperature detect for charging by Abner 	
 ...
 //[Arima Patch] 20140225 Maintenance charging by Abner	
...
//[Arima Patch] 20140213 Maintenance charging by Abner	
    	if(maintenance_counter > 1){
    			maintenance_counter = 72001;
 ...
 //[Arima Patch] 20140213 Maintenance charging by Abner  				
        ...
        //[Arima Patch] 20140701 Maintenance charging by Abner	
...
//[Arima Patch] 20131021 Maintenance charging by Abner	
	INIT_DELAYED_WORK(&chip_maint_pointer->chg_maintenance, qpnp_chg_maintenance);		//[Arima Patch] 20130225 Temperature detect for charging by Abner 
//[Arima Patch] 20131021 Maintenance charging by Abner
