			       ...
			       char __user *optval, unsigned int optlen)
{
	...
	if (level != SOL_PPPOL2TP)
		return -EINVAL;	//Security Incident SSIMS00000387
//		return udp_prot.setsockopt(sk, level, optname, optval, optlen);//Security Incident SSIMS00000387
			       ...
			       int optname, char __user *optval, int __user *optlen)
{
	...
	if (level != SOL_PPPOL2TP)
		return -EINVAL;//Security Incident SSIMS00000387
//		return udp_prot.getsockopt(sk, level, optname, optval, optlen);//Security Incident SSIMS00000387
